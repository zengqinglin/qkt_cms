	  ...
	  $( obj ).each(function(i){
		...
		if ( i == n ){
			...
			Cbtn.click(function(){
				...
				var l = ( $(window).width()- CInfo.width() )/2+350;
...
$(document).ready(function(){
	...
	$(".ab_li:eq(0)").css({"font-size":"25px","top":"60px",left:"60px",width:"25px","line-height":"32px"}).addClass("big");
	$(".ab_li:eq(1)").css({"font-size":"16px","top":"180px",left:"170px",width:"16px"});
	$(".ab_li:eq(2)").css({"font-size":"12px","top":"0px",left:"190px",width:"12px","line-height":"14px"});
	$(".ab_li:eq(3)").css({"font-size":"22px","top":"0px",left:"450px",width:"22px","line-height":"28px"}).addClass("big");
	$(".ab_li:eq(4)").css({"font-size":"12px","top":"140px",left:"525px",width:"12px","line-height":"14px"});
	$(".ab_li:eq(5)").css({"font-size":"18px","top":"360px",left:"240px",width:"18px","line-height":"24px"});
	$(".ab_li:eq(6)").css({"font-size":"26px","top":"280px",left:"80px",width:"26px","line-height":"32px"}).addClass("big");
	$(".ab_li:eq(7)").css({"font-size":"14px","top":"320px",left:"390px",width:"14px"});
	$(".ab_li:eq(8)").css({"font-size":"30px","top":"280px",left:"490px",width:"30px","line-height":"32px"}).addClass("big");
});
///////////////////////////////////////////////////
